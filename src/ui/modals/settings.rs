            ...
            hud_panel(ui, Vec2::new(360.0, 330.0), GOLD_DIM, |ui| {
                ...
                for dir in &["↑", "↓", "←", "→"] {
                    ui.horizontal(|ui| {
                        ...
                        if hud_button(ui, "🎬", Vec2::new(32.0, 24.0), GOLD_MID, false).clicked() {
                            app.capture.settings_capture = Some(dir.to_string());
                            app.capture.captured.clear();
                            app.capture.capturing = None;
                        }
                        ui.add(egui::TextEdit::singleline(v).font(hud(13.0)).desired_width(64.0));
                    });
                }
                ui.add_space(6.0);
                ui.horizontal(|ui| {
                    ...
                    ui.add(egui::TextEdit::singleline(&mut app.settings_key).font(hud(13.0)).desired_width(80.0));
                });
                ui.horizontal(|ui| {
