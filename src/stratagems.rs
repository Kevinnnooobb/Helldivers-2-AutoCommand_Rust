...
/// 强化（Booster）—— 独立分类，数据来自 helldivers.wiki.gg/wiki/Boosters，
/// 与战备不是同一套东西（没有方向指令，只有被动效果）
pub const CAT_BOOSTERS: &str = "Boosters";
...
pub static STRATAGEMS: &[Stratagem] = &[
    // ─── 任务战备 ───
    Stratagem {
        category: CAT_MISSION,
        model: "无型号",
        name: "增援",
        command: cmd![UP, DOWN, RIGHT, LEFT, UP],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "补给",
        command: cmd![DOWN, DOWN, UP, RIGHT],
        description: "呼叫补给",
        icon: "resupply",
    },
    Stratagem {
        ...
        model: "无型号",
        name: "飞鹰重新装填",
        command: cmd![UP, UP, LEFT, UP, RIGHT],
        description: "令飞鹰返回补给弹药",
        icon: "eagle_rearm",
    },
    Stratagem {
        category: CAT_MISSION,
        model: "无型号",
        name: "SSSD 交付",
        command: cmd![UP, UP, DOWN, DOWN, RIGHT, DOWN],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "地狱炸弹",
        command: cmd![DOWN, UP, LEFT, DOWN, UP, RIGHT, DOWN, UP],
        description: "呼叫地狱炸弹",
        icon: "hellbomb",
    },
    Stratagem {
        ...
        model: "无型号",
        name: "上传数据",
        command: cmd![LEFT, RIGHT, UP, UP, UP],
        description: "上传逃生舱数据",
        icon: "upload_data",
    },
    Stratagem {
        ...
        model: "无型号",
        name: "地震探测器",
        command: cmd![UP, UP, LEFT, RIGHT, DOWN, DOWN],
        description: "地质勘测副目标",
        icon: "seismic_probe",
    },
    Stratagem {
        ...
        model: "无型号",
        name: "暗流体容器",
        command: cmd![UP, LEFT, RIGHT, DOWN, UP, UP],
        description: "暗流体任务专属",
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "蜂巢破碎钻机",
        command: cmd![LEFT, UP, DOWN, RIGHT, DOWN, DOWN],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "SEAF 火炮",
        command: cmd![RIGHT, UP, UP, DOWN],
        description: "完成 SEAF 火炮副目标后解锁",
        icon: "seaf_artillery",
    },
    Stratagem {
        category: CAT_MISSION,
        model: "无型号",
        name: "呼叫超级驱逐舰",
        command: cmd![UP, UP, DOWN, DOWN, LEFT, RIGHT, LEFT, RIGHT],
        description: "突击任务中呼叫支援",
        icon: "call_in_super_destroyer",
    },
    // ─── 轨道火力 ───
    // 指令码来源：helldivers.wiki.gg/wiki/Stratagems
    Stratagem {
        category: CAT_ORBITAL,
        model: "无型号",
        name: "轨道精准打击",
        command: cmd![RIGHT, RIGHT, UP],
        description: "单发精确轨道炮击",
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道加特林火力网",
        command: cmd![RIGHT, DOWN, LEFT, UP, UP],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道120MM高爆弹火力网",
        command: cmd![RIGHT, RIGHT, DOWN, LEFT, RIGHT, DOWN],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道380MM高爆弹火力网",
        command: cmd![RIGHT, DOWN, UP, UP, LEFT, DOWN, DOWN],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道游走火力网",
        command: cmd![RIGHT, DOWN, RIGHT, DOWN, RIGHT, DOWN],
        description: "线性推进弹幕",
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道激光炮",
        command: cmd![RIGHT, DOWN, UP, RIGHT, DOWN],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道凝固汽油弹火力网",
        command: cmd![RIGHT, RIGHT, DOWN, LEFT, RIGHT, UP],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道炮攻击",
        command: cmd![RIGHT, UP, DOWN, DOWN, RIGHT],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道烟雾攻击",
        command: cmd![RIGHT, RIGHT, DOWN, UP],
        description: "投放烟幕遮蔽",
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道毒气攻击",
        command: cmd![RIGHT, RIGHT, DOWN, RIGHT],
        description: "毒气弹幕覆盖",
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "轨道电磁攻击",
        command: cmd![RIGHT, RIGHT, LEFT, DOWN],
        description: "电磁脉冲瘫痪目标",
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "飞鹰空袭",
        command: cmd![UP, RIGHT, DOWN, RIGHT],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "飞鹰集束炸弹",
        command: cmd![UP, RIGHT, DOWN, DOWN, RIGHT],
    ...
    Stratagem {
        ...
        model: "无型号",
        name: "飞鹰500KG炸弹",
        command: cmd![UP, RIGHT, DOWN, DOWN, DOWN],
        description: "飞鹰大型炸弹",
        icon: "eagle_500kg_bomb",
    },
    // 来源：helldivers.wiki.gg/wiki/Stratagems（战役 Counterdissident Hammer 解锁）
    Stratagem {
        category: CAT_EAGLE,
        model: "无型号",
        name: "飞鹰毒气空袭",
        command: cmd![UP, RIGHT, LEFT, RIGHT],
        description: "飞鹰投放毒气弹幕",
        icon: "eagle_gas_airstrike",
    },
    // ─── 支援武器 ───
    Stratagem {
        ...
        model: "MG-43",
        name: "机枪",
        command: cmd![DOWN, LEFT, DOWN, UP, RIGHT],
        description: "固定机枪",
        icon: "machine_gun",
    },
    Stratagem {
        ...
        model: "APW-1",
        name: "反器材步枪",
        command: cmd![DOWN, LEFT, RIGHT, UP, DOWN],
        description: "高口径狙击步枪",
    ...
    Stratagem {
        ...
        model: "M-105",
        name: "盟友",
        command: cmd![DOWN, LEFT, DOWN, UP, UP, LEFT],
        description: "紧凑型轻机枪",
        icon: "stalwart",
    },
    Stratagem {
        ...
        model: "EAT-17",
        name: "消耗性反坦克",
        command: cmd![DOWN, DOWN, LEFT, UP, RIGHT],
        description: "单次使用反坦克武器",
    ...
    Stratagem {
        ...
        model: "GR-8",
        name: "无后坐力炮",
        command: cmd![DOWN, LEFT, RIGHT, RIGHT, LEFT],
        description: "无后坐力炮",
    ...
    Stratagem {
        ...
        model: "FLAM-40",
        name: "火焰喷射器",
        command: cmd![DOWN, LEFT, UP, DOWN, UP],
        description: "近距燃烧武器",
        icon: "flamethrower",
    },
    Stratagem {
        ...
        model: "AC-8",
        name: "机炮",
        command: cmd![DOWN, LEFT, DOWN, UP, UP, RIGHT],
        description: "全自动机炮",
        icon: "autocannon",
    },
    Stratagem {
        ...
        model: "MG-206",
        name: "重机枪",
        command: cmd![DOWN, LEFT, UP, DOWN, DOWN],
        description: "强力机枪",
    ...
    Stratagem {
        ...
        model: "RL-77",
        name: "空爆火箭弹发射器",
        command: cmd![DOWN, UP, UP, LEFT, RIGHT],
        description: "发射空爆火箭",
    ...
    Stratagem {
        ...
        model: "MLS-4X",
        name: "突击兵",
        command: cmd![DOWN, LEFT, UP, DOWN, RIGHT],
        description: "一次性激光制导导弹",
        icon: "commando",
    },
    Stratagem {
        category: CAT_SUPPORT,
        model: "RS-422",
        name: "磁轨炮",
        command: cmd![DOWN, RIGHT, DOWN, UP, LEFT, RIGHT],
        description: "实验性穿甲武器",
        icon: "railgun",
    },
    Stratagem {
        ...
        model: "FAF-14",
        name: "飞矛",
        command: cmd![DOWN, DOWN, UP, DOWN, DOWN],
        description: "自导反坦克导弹",
        icon: "spear",
    },
    Stratagem {
        ...
        model: "StA-X3",
        name: "W.A.S.P.发射器",
        command: cmd![DOWN, DOWN, UP, DOWN, RIGHT],
        description: "七枚追踪导弹",
    ...
    Stratagem {
        ...
        model: "GL-21",
        name: "榴弹发射器",
        command: cmd![DOWN, LEFT, UP, LEFT, DOWN],
        description: "对装甲步兵有效",
    ...
    Stratagem {
        ...
        model: "LAS-98",
        name: "激光大炮",
        command: cmd![DOWN, LEFT, DOWN, UP, LEFT],
        description: "连续激光武器",
        icon: "laser_cannon",
    },
    Stratagem {
        ...
        model: "ARC-3",
        name: "电弧发射器",
        command: cmd![DOWN, RIGHT, DOWN, UP, LEFT, LEFT],
        description: "电弧武器近距",
        icon: "arc_thrower",
    },
    Stratagem {
        ...
        model: "LAS-99",
        name: "类星体加农炮",
        command: cmd![DOWN, DOWN, UP, LEFT, RIGHT],
        description: "蓄能爆炸能量炮",
        icon: "quasar_cannon",
    },
    Stratagem {
        ...
        model: "TX-41",
        name: "灭菌器",
        command: cmd![DOWN, LEFT, UP, DOWN, LEFT],
    ...
    Stratagem {
        ...
        model: "S-11",
        name: "矛枪",
        command: cmd![DOWN, RIGHT, DOWN, LEFT, UP, RIGHT],
        description: "反坦克鱼叉枪",
        icon: "speargun",
    },
    Stratagem {
        ...
        model: "M-1000",
        name: "重装机枪",
        command: cmd![DOWN, LEFT, RIGHT, DOWN, UP, UP],
    ...
    Stratagem {
        ...
        model: "EAT-700",
        name: "消耗性凝固汽油弹",
        command: cmd![DOWN, DOWN, LEFT, UP, LEFT],
        description: "单发凝固汽油弹",
    ...
    Stratagem {
        ...
        model: "GL-52",
        name: "缓和使者",
        command: cmd![DOWN, RIGHT, UP, LEFT, RIGHT],
        description: "人道榴弹发射器",
    ...
    Stratagem {
        ...
        model: "CQC-9",
        name: "除叶工具",
        command: cmd![DOWN, LEFT, RIGHT, RIGHT, DOWN],
        description: "清场工具",
    ...
    Stratagem {
        ...
        model: "CQC-20",
        name: "破门锤",
        command: cmd![DOWN, LEFT, RIGHT, LEFT, UP],
        description: "破坏工具",
        icon: "cqc_20",
    },
    // 来源：helldivers.wiki.gg/wiki/B/FLAM-80_Cremator（1.006.100 加入）
    Stratagem {
        category: CAT_SUPPORT,
        model: "B/FLAM-80",
        name: "焚化者",
        command: cmd![DOWN, DOWN, RIGHT, DOWN, UP, UP],
        description: "背包供弹重型火焰喷射器",
        icon: "cremator",
    },
    // ─── 哨戒炮 ───
    Stratagem {
        category: CAT_SENTRIES,
        model: "A/MG-43",
        name: "哨戒机枪",
        command: cmd![DOWN, UP, RIGHT, RIGHT, UP],
        description: "自动机枪哨戒",
    ...
    Stratagem {
        ...
        model: "A/G-16",
        name: "加特林哨戒炮",
        command: cmd![DOWN, UP, RIGHT, LEFT],
        description: "高射速自动炮",
        icon: "gatling_sentry",
    },
    Stratagem {
        ...
        model: "A/M-12",
        name: "迫击哨戒炮",
        command: cmd![DOWN, UP, RIGHT, RIGHT, DOWN],
        description: "高抛炮击",
        icon: "mortar_sentry",
    },
    Stratagem {
        ...
        model: "A/AC-8",
        name: "自动哨戒炮",
        command: cmd![DOWN, UP, RIGHT, UP, LEFT, UP],
        description: "远程反装甲炮",
    ...
    Stratagem {
        ...
        model: "AX/AR-23",
        name: "护卫犬",
        command: cmd![DOWN, UP, LEFT, UP, RIGHT, DOWN],
        description: "护卫无人机",
        icon: "guard_dog",
    },
    Stratagem {
        ...
        model: "A/MLS-4X",
        name: "火箭哨戒炮",
        command: cmd![DOWN, UP, RIGHT, RIGHT, LEFT],
        description: "火箭弹哨戒",
        icon: "rocket_sentry",
    },
    // 来源：helldivers.wiki.gg/wiki/A/ARC-3_Tesla_Tower
    Stratagem {
        category: CAT_SENTRIES,
        model: "A/ARC-3",
        name: "特斯拉塔",
        command: cmd![DOWN, UP, RIGHT, UP, LEFT, RIGHT],
        description: "近距离电弧哨戒炮台",
        icon: "tesla_tower",
    },
    Stratagem {
        category: CAT_SENTRIES,
        model: "AX/TX-41",
        name: "灭杀犬",
        command: cmd![DOWN, UP, LEFT, UP, RIGHT, UP],
        description: "化学护卫无人机",
        icon: "guard_dog_breath",
    },
    // ─── 地雷，盾和手操炮台 ───
    Stratagem {
        category: CAT_EMPLACEMENTS,
        model: "MD-6",
        name: "反步兵雷区",
        command: cmd![DOWN, LEFT, UP, RIGHT],
        description: "反步兵地雷",
    ...
    Stratagem {
        ...
        model: "MD-I4",
        name: "燃烧地雷",
        command: cmd![DOWN, LEFT, LEFT, DOWN],
        description: "燃烧地雷区",
    ...
    Stratagem {
        ...
        model: "SH-32",
        name: "防护罩生成器",
        command: cmd![DOWN, UP, LEFT, RIGHT, LEFT, RIGHT],
        description: "护盾圆顶",
    ...
    Stratagem {
        ...
        model: "FX-12",
        name: "防护罩生成中继器",
        command: cmd![DOWN, DOWN, LEFT, RIGHT, LEFT, RIGHT],
        description: "防护盾中继器",
    ...
    Stratagem {
        ...
        model: "E/MG-101",
        name: "重机枪炮台",
        command: cmd![DOWN, UP, LEFT, RIGHT, RIGHT, LEFT],
        description: "手动操作重机枪炮台",
    ...
    Stratagem {
        ...
        model: "AT-47",
        name: "反坦克炮台",
        command: cmd![DOWN, UP, LEFT, RIGHT, RIGHT, RIGHT],
        description: "手动操作反坦克炮台",
        icon: "anti_tank_emplacement",
    },
    // ─── 背包 ───
    Stratagem {
        category: CAT_BACKPACKS,
        model: "B-1",
        name: "补给背包",
        command: cmd![DOWN, LEFT, DOWN, UP, UP, DOWN],
        description: "弹药补给背包",
        icon: "supply_pack",
    },
    Stratagem {
        ...
        model: "LIFT-850",
        name: "喷射背包",
        command: cmd![DOWN, UP, UP, DOWN, UP],
        description: "飞行背包",
        icon: "jump_pack",
    },
    Stratagem {
        ...
        model: "AX/LAS-5",
        name: "护卫犬漫游车",
        command: cmd![DOWN, UP, LEFT, UP, RIGHT, RIGHT],
        description: "激光护卫无人机背包",
    ...
    Stratagem {
        ...
        model: "SH-20",
        name: "防弹护盾背包",
        command: cmd![DOWN, LEFT, DOWN, DOWN, UP, LEFT],
        description: "防弹护盾",
    ...
    Stratagem {
        ...
        model: "SH-51",
        name: "定向护盾",
        command: cmd![DOWN, UP, LEFT, RIGHT, UP, UP],
        description: "定向护盾背包",
    ...
    Stratagem {
        ...
        model: "N/A",
        name: "地狱炸弹",
        command: cmd![DOWN, RIGHT, UP, UP, UP],
        description: "核弹背包",
    ...
    Stratagem {
        ...
        model: "M-102",
        name: "侦察吉普",
        command: cmd![LEFT, DOWN, RIGHT, DOWN, RIGHT, DOWN, UP],
        description: "快速侦察载具",
    ...
    Stratagem {
        ...
        model: "PATRIOT",
        name: "爱国者外骨骼装甲",
        command: cmd![LEFT, DOWN, RIGHT, UP, LEFT, DOWN, DOWN],
        description: "重武器外骨骼",
    ...
    Stratagem {
        ...
        model: "EMANCIPATOR",
        name: "解放者外骨骼装甲",
        command: cmd![LEFT, DOWN, RIGHT, UP, LEFT, DOWN, UP],
        description: "双自动炮外骨骼",
        icon: "emancipator_exosuit",
    },
    // 来源：helldivers.wiki.gg/wiki/EXO-51_Lumberer_Exosuit（1.006.202 加入）
    Stratagem {
        category: CAT_VEHICLES,
        model: "EXO-51",
        name: "伐木者外骨骼装甲",
        command: cmd![LEFT, DOWN, RIGHT, UP, RIGHT, LEFT, UP],
        description: "反坦克炮 + 火焰喷射器外骨骼",
        icon: "lumberer_exosuit",
    },
];

/// 附加分类：来自战备总览页之外的独立页面（目前只有 Boosters）。
/// 排在战备分类之后，保证战备的页面顺序不被改变。
pub const EXTRA_CATEGORY_ORDER: &[&str] = &[CAT_BOOSTERS];

/// 分类栏顺序：战备分类以 helldivers.wiki.gg/wiki/Stratagems 页面为准，
/// 其后追加强化分类（helldivers.wiki.gg/wiki/Boosters）。
pub fn get_categories() -> Vec<&'static str> {
    let mut cats = PAGE_CATEGORY_ORDER.to_vec();
    cats.extend_from_slice(EXTRA_CATEGORY_ORDER);
    cats
}
...
mod tests {
    ...
    fn categories_follow_page_order() {
        ...
        // 战备分类顺序以 helldivers.wiki.gg/wiki/Stratagems 页面为准，
        // 之后追加强化分类（独立页面 /wiki/Boosters）
        assert_eq!(
            cats,
            vec![
                CAT_ORBITAL,
        ...
        // 战备页面顺序本身不得被强化分类改变
        assert_eq!(&cats[..PAGE_CATEGORY_ORDER.len()], PAGE_CATEGORY_ORDER);
        assert_eq!(EXTRA_CATEGORY_ORDER, &[CAT_BOOSTERS]);
    }
